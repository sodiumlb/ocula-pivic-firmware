...
#define NTSC_COLBURST_O     CVBS_CMD_BURST(13, 5, 9, 8,17)
#define NTSC_COLBURST_E     CVBS_CMD_BURST( 5,13, 9, 8,17)
...
#define NTSC_CYAN_0	CVBS_CMD_PIXEL(16,33,30, 3,30)
#define NTSC_CYAN_4	CVBS_CMD_PIXEL(30,33,16, 3,16)
#define NTSC_CYAN_1	CVBS_CMD_PIXEL(16,44,30, 3,30)
#define NTSC_CYAN_5	CVBS_CMD_PIXEL(30,44,16, 3,16)
#define NTSC_CYAN_2	CVBS_CMD_PIXEL(30,11,16,44,30)
#define NTSC_CYAN_6	CVBS_CMD_PIXEL(16,11,30,44,16)
#define NTSC_CYAN_3	CVBS_CMD_PIXEL(30,22,16,44,30)
#define NTSC_CYAN_7	CVBS_CMD_PIXEL(16,22,30,44,16)
#define NTSC_PURPLE_0	CVBS_CMD_PIXEL(23,44, 9, 3, 9)
#define NTSC_PURPLE_4	CVBS_CMD_PIXEL( 9,44,23, 3,23)
#define NTSC_PURPLE_1	CVBS_CMD_PIXEL( 9,11,23,44, 9)
#define NTSC_PURPLE_5	CVBS_CMD_PIXEL(23,11, 9,44,23)
#define NTSC_PURPLE_2	CVBS_CMD_PIXEL( 9,22,23,44, 9)
#define NTSC_PURPLE_6	CVBS_CMD_PIXEL(23,22, 9,44,23)
#define NTSC_PURPLE_3	CVBS_CMD_PIXEL( 9,33,23, 3,23)
#define NTSC_PURPLE_7	CVBS_CMD_PIXEL(23,33, 9, 3, 9)
#define NTSC_GREEN_0	CVBS_CMD_PIXEL(14,39,28, 3,28)
#define NTSC_GREEN_4	CVBS_CMD_PIXEL(28,39,14, 3,14)
#define NTSC_GREEN_1	CVBS_CMD_PIXEL(28, 6,14,44,28)
#define NTSC_GREEN_5	CVBS_CMD_PIXEL(14, 6,28,44,14)
#define NTSC_GREEN_2	CVBS_CMD_PIXEL(28,17,14,44,28)
#define NTSC_GREEN_6	CVBS_CMD_PIXEL(14,17,28,44,14)
#define NTSC_GREEN_3	CVBS_CMD_PIXEL(28,28,14,44,28)
#define NTSC_GREEN_7	CVBS_CMD_PIXEL(14,28,28,44,14)
#define NTSC_BLUE_0	CVBS_CMD_PIXEL( 6,12,20,44, 6)
#define NTSC_BLUE_4	CVBS_CMD_PIXEL(20,12, 6,44,20)
#define NTSC_BLUE_1	CVBS_CMD_PIXEL( 6,23,20,44, 6)
#define NTSC_BLUE_5	CVBS_CMD_PIXEL(20,23, 6,44,20)
#define NTSC_BLUE_2	CVBS_CMD_PIXEL( 6,34,20, 3,20)
#define NTSC_BLUE_6	CVBS_CMD_PIXEL(20,34, 6, 3, 6)
#define NTSC_BLUE_3	CVBS_CMD_PIXEL( 6,45,20, 3,20)
#define NTSC_BLUE_7	CVBS_CMD_PIXEL(20,45, 6, 3, 6)
...
#define NTSC_ORANGE_0	CVBS_CMD_PIXEL(24,27,10,44,24)
#define NTSC_ORANGE_4	CVBS_CMD_PIXEL(10,27,24,44,10)
#define NTSC_ORANGE_1	CVBS_CMD_PIXEL(24,38,10, 3,10)
#define NTSC_ORANGE_5	CVBS_CMD_PIXEL(10,38,24, 3,24)
#define NTSC_ORANGE_2	CVBS_CMD_PIXEL(10, 5,24,44,10)
#define NTSC_ORANGE_6	CVBS_CMD_PIXEL(24, 5,10,44,24)
#define NTSC_ORANGE_3	CVBS_CMD_PIXEL(10,16,24,44,10)
#define NTSC_ORANGE_7	CVBS_CMD_PIXEL(24,16,10,44,24)
#define NTSC_LORANGE_0	CVBS_CMD_PIXEL(27,27,19,44,27)
#define NTSC_LORANGE_4	CVBS_CMD_PIXEL(19,27,27,44,19)
#define NTSC_LORANGE_1	CVBS_CMD_PIXEL(27,38,19, 3,19)
#define NTSC_LORANGE_5	CVBS_CMD_PIXEL(19,38,27, 3,27)
#define NTSC_LORANGE_2	CVBS_CMD_PIXEL(19, 5,27,44,19)
#define NTSC_LORANGE_6	CVBS_CMD_PIXEL(27, 5,19,44,27)
#define NTSC_LORANGE_3	CVBS_CMD_PIXEL(19,16,27,44,19)
#define NTSC_LORANGE_7	CVBS_CMD_PIXEL(27,16,19,44,27)
...
#define NTSC_LCYAN_0	CVBS_CMD_PIXEL(22,33,30, 3,30)
#define NTSC_LCYAN_4	CVBS_CMD_PIXEL(30,33,22, 3,22)
#define NTSC_LCYAN_1	CVBS_CMD_PIXEL(22,44,30, 3,30)
#define NTSC_LCYAN_5	CVBS_CMD_PIXEL(30,44,22, 3,22)
#define NTSC_LCYAN_2	CVBS_CMD_PIXEL(30,11,22,44,30)
#define NTSC_LCYAN_6	CVBS_CMD_PIXEL(22,11,30,44,22)
#define NTSC_LCYAN_3	CVBS_CMD_PIXEL(30,22,22,44,30)
#define NTSC_LCYAN_7	CVBS_CMD_PIXEL(22,22,30,44,22)
#define NTSC_LPURPLE_0	CVBS_CMD_PIXEL(27,44,19, 3,19)
#define NTSC_LPURPLE_4	CVBS_CMD_PIXEL(19,44,27, 3,27)
#define NTSC_LPURPLE_1	CVBS_CMD_PIXEL(19,11,27,44,19)
#define NTSC_LPURPLE_5	CVBS_CMD_PIXEL(27,11,19,44,27)
#define NTSC_LPURPLE_2	CVBS_CMD_PIXEL(19,22,27,44,19)
#define NTSC_LPURPLE_6	CVBS_CMD_PIXEL(27,22,19,44,27)
#define NTSC_LPURPLE_3	CVBS_CMD_PIXEL(19,33,27, 3,27)
#define NTSC_LPURPLE_7	CVBS_CMD_PIXEL(27,33,19, 3,19)
