...
#define NTSC_COLBURST_O     CVBS_CMD_BURST(12, 6, 9, 5,17)
#define NTSC_COLBURST_E     CVBS_CMD_BURST( 6,12, 9, 5,17)
...
#define NTSC_BLACK     CVBS_CMD_PIXEL(11,44,11,3,11)
#define NTSC_WHITE     CVBS_CMD_PIXEL(29,44,29,3,29)

#define NTSC_RED_0     CVBS_CMD_PIXEL(18,28,10,44,18)
#define NTSC_RED_4     CVBS_CMD_PIXEL(10,28,18,44,10)
#define NTSC_RED_1     CVBS_CMD_PIXEL(18,39,10, 3,10)
#define NTSC_RED_5     CVBS_CMD_PIXEL(10,39,18, 3,18)
#define NTSC_RED_2     CVBS_CMD_PIXEL(10, 6,18,44,10)
#define NTSC_RED_6     CVBS_CMD_PIXEL(18, 6,10,44,18)
#define NTSC_RED_3     CVBS_CMD_PIXEL(10,17,18,44,10)
#define NTSC_RED_7     CVBS_CMD_PIXEL(18,17,10,44,18)
#define NTSC_CYAN_0    CVBS_CMD_PIXEL(19,28,27,44,19)
#define NTSC_CYAN_4    CVBS_CMD_PIXEL(27,28,19,44,27)
#define NTSC_CYAN_1    CVBS_CMD_PIXEL(19,39,27, 3,27)
#define NTSC_CYAN_5    CVBS_CMD_PIXEL(27,39,19, 3,19)
#define NTSC_CYAN_2    CVBS_CMD_PIXEL(27, 6,19,44,27)
#define NTSC_CYAN_6    CVBS_CMD_PIXEL(19, 6,27,44,19)
#define NTSC_CYAN_3    CVBS_CMD_PIXEL(27,17,19,44,27)
#define NTSC_CYAN_7    CVBS_CMD_PIXEL(19,17,27,44,19)
#define NTSC_PURPLE_0  CVBS_CMD_PIXEL(20,32,12,44,20)
#define NTSC_PURPLE_4  CVBS_CMD_PIXEL(12,32,20,44,12)
#define NTSC_PURPLE_1  CVBS_CMD_PIXEL(20,43,12, 3,12)
#define NTSC_PURPLE_5  CVBS_CMD_PIXEL(12,43,20, 3,20)
#define NTSC_PURPLE_2  CVBS_CMD_PIXEL(12,10,20,44,12)
#define NTSC_PURPLE_6  CVBS_CMD_PIXEL(20,10,12,44,20)
#define NTSC_PURPLE_3  CVBS_CMD_PIXEL(12,21,20,44,12)
#define NTSC_PURPLE_7  CVBS_CMD_PIXEL(20,21,12,44,20)
#define NTSC_GREEN_0   CVBS_CMD_PIXEL(17,32,25,44,17)
#define NTSC_GREEN_4   CVBS_CMD_PIXEL(25,32,17,44,25)
#define NTSC_GREEN_1   CVBS_CMD_PIXEL(17,43,25, 3,25)
#define NTSC_GREEN_5   CVBS_CMD_PIXEL(25,43,17, 3,17)
#define NTSC_GREEN_2   CVBS_CMD_PIXEL(25,10,17,44,25)
#define NTSC_GREEN_6   CVBS_CMD_PIXEL(17,10,25,44,17)
#define NTSC_GREEN_3   CVBS_CMD_PIXEL(25,21,17,44,25)
#define NTSC_GREEN_7   CVBS_CMD_PIXEL(17,21,25,44,17)
#define NTSC_BLUE_0    CVBS_CMD_PIXEL( 9,16,17,44, 9)
#define NTSC_BLUE_4    CVBS_CMD_PIXEL(17,16, 9,44,17)
#define NTSC_BLUE_1    CVBS_CMD_PIXEL( 9,27,17,44, 9)
#define NTSC_BLUE_5    CVBS_CMD_PIXEL(17,27, 9,44,17)
#define NTSC_BLUE_2    CVBS_CMD_PIXEL( 9,38,17, 3,17)
#define NTSC_BLUE_6    CVBS_CMD_PIXEL(17,38, 9, 3, 9)
#define NTSC_BLUE_3    CVBS_CMD_PIXEL(17, 5, 9,44,17)
#define NTSC_BLUE_7    CVBS_CMD_PIXEL( 9, 5,17,44, 9)
#define NTSC_YELLOW_0  CVBS_CMD_PIXEL(28,16,20,44,28)
#define NTSC_YELLOW_4  CVBS_CMD_PIXEL(20,16,28,44,20)
#define NTSC_YELLOW_1  CVBS_CMD_PIXEL(28,27,20,44,28)
#define NTSC_YELLOW_5  CVBS_CMD_PIXEL(20,27,28,44,20)
#define NTSC_YELLOW_2  CVBS_CMD_PIXEL(28,38,20, 3,20)
#define NTSC_YELLOW_6  CVBS_CMD_PIXEL(20,38,28, 3,28)
#define NTSC_YELLOW_3  CVBS_CMD_PIXEL(20, 5,28,44,20)
#define NTSC_YELLOW_7  CVBS_CMD_PIXEL(28, 5,20,44,28)
#define NTSC_ORANGE_0  CVBS_CMD_PIXEL(21,18,13,44,21)
#define NTSC_ORANGE_4  CVBS_CMD_PIXEL(13,18,21,44,13)
#define NTSC_ORANGE_1  CVBS_CMD_PIXEL(21,29,13,44,21)
#define NTSC_ORANGE_5  CVBS_CMD_PIXEL(13,29,21,44,13)
#define NTSC_ORANGE_2  CVBS_CMD_PIXEL(21,40,13, 3,13)
#define NTSC_ORANGE_6  CVBS_CMD_PIXEL(13,40,21, 3,21)
#define NTSC_ORANGE_3  CVBS_CMD_PIXEL(13, 7,21,44,13)
#define NTSC_ORANGE_7  CVBS_CMD_PIXEL(21, 7,13,44,21)
