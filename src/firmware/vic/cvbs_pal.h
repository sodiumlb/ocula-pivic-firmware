...
#define PAL_LONG_SYNC_L1  CVBS_CMD_PAL_DC_RUN( 0,66)
#define PAL_LONG_SYNC_L2  CVBS_CMD_PAL_DC_RUN( 0,67)
...
#define PAL_SHORT_SYNC_H1 CVBS_CMD_PAL_DC_RUN(36,66)
#define PAL_SHORT_SYNC_H2 CVBS_CMD_PAL_DC_RUN(36,67)
