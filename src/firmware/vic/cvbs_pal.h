...
#define PAL_FRONTPORCH   CVBS_CMD_PAL_DC_RUN(18, 7)
#define PAL_FRONTPORCH_1 CVBS_CMD_PAL_DC_RUN(18, 5)        // First part is from last pixel of HC=70 to end of HC=0.
#define PAL_FRONTPORCH_2 CVBS_CMD_PAL_DC_RUN(18, 2)        // Other two in HC=1 up to HC=1.5
...
#define PAL_BLANKING     CVBS_CMD_PAL_DC_RUN(18,233)
...
#define PAL_TRUNC_BLACK	        CVBS_CMD_PAL_PIXEL(18,18,18, 6,18)
#define PAL_TRUNC_WHITE	        CVBS_CMD_PAL_PIXEL(23,18,23, 6,18)
#define PAL_TRUNC_RED_O	        CVBS_CMD_PAL_PIXEL(10,10, 5,14,18)
#define PAL_TRUNC_RED_E	        CVBS_CMD_PAL_PIXEL( 5, 8,10,16,18)
#define PAL_TRUNC_CYAN_O	CVBS_CMD_PAL_PIXEL(15,10, 9,14,18)
#define PAL_TRUNC_CYAN_E	CVBS_CMD_PAL_PIXEL( 9, 8,15,16,18)
#define PAL_TRUNC_PURPLE_O      CVBS_CMD_PAL_PIXEL(22, 5,29,18,18)
#define PAL_TRUNC_PURPLE_E      CVBS_CMD_PAL_PIXEL(29,13,22,11,18)
#define PAL_TRUNC_GREEN_O       CVBS_CMD_PAL_PIXEL( 7, 6, 1,18,18)
#define PAL_TRUNC_GREEN_E	CVBS_CMD_PAL_PIXEL( 1,12, 7,12,18)
#define PAL_TRUNC_BLUE_O	CVBS_CMD_PAL_PIXEL( 9,18,10, 6,18)
#define PAL_TRUNC_BLUE_E	CVBS_CMD_PAL_PIXEL( 9,18,10, 6,18)
#define PAL_TRUNC_YELLOW_O      CVBS_CMD_PAL_PIXEL( 5,18,15, 6,18)
#define PAL_TRUNC_YELLOW_E      CVBS_CMD_PAL_PIXEL( 5,18,15, 6,18)
#define PAL_TRUNC_ORANGE_O      CVBS_CMD_PAL_PIXEL(22,13,19,11,18)
#define PAL_TRUNC_ORANGE_E      CVBS_CMD_PAL_PIXEL(19, 5,22,18,18)
#define PAL_TRUNC_LORANGE_O     CVBS_CMD_PAL_PIXEL(21,13,27,11,18)
#define PAL_TRUNC_LORANGE_E     CVBS_CMD_PAL_PIXEL(27, 5,21,18,18)
#define PAL_TRUNC_PINK_O	CVBS_CMD_PAL_PIXEL( 5,10,11,14,18)
#define PAL_TRUNC_PINK_E	CVBS_CMD_PAL_PIXEL(11, 8, 5,16,18)
#define PAL_TRUNC_LCYAN_O	CVBS_CMD_PAL_PIXEL(15,10, 3,14,18)
#define PAL_TRUNC_LCYAN_E	CVBS_CMD_PAL_PIXEL( 3, 8,15,16,18)
#define PAL_TRUNC_LPURPLE_O     CVBS_CMD_PAL_PIXEL(21, 5,27,18,18)
#define PAL_TRUNC_LPURPLE_E     CVBS_CMD_PAL_PIXEL(27,13,21,11,18)
#define PAL_TRUNC_LGREEN_O      CVBS_CMD_PAL_PIXEL(23, 6,29,18,18)
#define PAL_TRUNC_LGREEN_E      CVBS_CMD_PAL_PIXEL(29,12,23,12,18)
#define PAL_TRUNC_LBLUE_O	CVBS_CMD_PAL_PIXEL( 3,18, 5, 6,18)
#define PAL_TRUNC_LBLUE_E	CVBS_CMD_PAL_PIXEL( 3,18, 5, 6,18)
#define PAL_TRUNC_LYELLOW_O     CVBS_CMD_PAL_PIXEL(19,18,31, 6,18)
#define PAL_TRUNC_LYELLOW_E     CVBS_CMD_PAL_PIXEL(19,18,31, 6,18)
